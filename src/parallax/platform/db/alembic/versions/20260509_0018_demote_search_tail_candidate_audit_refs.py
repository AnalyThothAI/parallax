"""Demote search-only tails still referenced only by candidate audit lists."""
        ...
        demotion_targets AS (
          ...
          WHERE ranked_search_assets.chain_symbol_rank > 3
            AND NOT EXISTS (
              ...
              WHERE protected_targets.asset_id = ranked_search_assets.asset_id
            )
        )
