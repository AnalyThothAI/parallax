...
from parallax.platform.agent_execution import RUNTIME_VERSION, AgentCapacityReservation, AgentStageSpec
from parallax.platform.agent_hashing import artifact_hash_for, json_sha256

WORKFLOW_NAME = "parallax.narrative_intel"
...
def _instructions(filename: str) -> str:
    return files("parallax.domains.narrative_intel.prompts").joinpath(filename).read_text(encoding="utf-8")
