...
def build_news_research_tool_registry() -> dict[str, NewsResearchToolDefinition]:
    return {
        ...
        "get_observation_history": NewsResearchToolDefinition(
            ...
            source_tables=["news_items", "news_observations"],
            max_rows=25,
            max_chars=1_400,
        ...
        "get_source_quality": NewsResearchToolDefinition(
            ...
            source_tables=["news_sources", "news_source_quality"],
            max_rows=8,
            max_chars=900,
        ...
        "get_target_news_context": NewsResearchToolDefinition(
            ...
            source_tables=["news_items", "news_token_mentions", "asset_identity_current"],
            max_rows=12,
            max_chars=1_600,
        ...
        "search_news_archive": NewsResearchToolDefinition(
            ...
            source_tables=["news_items", "news_token_mentions"],
            max_rows=8,
            max_chars=1_600,
