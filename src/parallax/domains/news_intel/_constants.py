...
NEWS_ITEM_BRIEF_PROMPT_VERSION = "news-item-brief-v2"
NEWS_ITEM_BRIEF_SCHEMA_VERSION = "news_item_brief_v1"
NEWS_ITEM_BRIEF_VALIDATOR_VERSION = "news_item_brief_validator_v2"
NEWS_ITEM_BRIEF_GUARDRAIL_VERSION = "news_item_brief_guardrails_v2"
