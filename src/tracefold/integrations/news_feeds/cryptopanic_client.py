...
from tracefold.integrations.news_feeds.feed_client import FeedFetchResult

DEFAULT_CRYPTOPANIC_PROFILE_DIR = Path(gettempdir()) / "tracefold" / "cryptopanic-profile"
