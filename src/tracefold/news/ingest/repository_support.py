...
from tracefold.news.ingest.extraction_contracts import NewsEntity, NewsFactCandidate, NewsTokenMention
from tracefold.news.ingest.market_scope import NewsMarketScope
from tracefold.news.ingest.material_identity import (
    material_title_fingerprint,
    material_title_is_eligible,
    provider_symbol_set,
    symbol_sets_compatible,
)
from tracefold.news.ingest.source_classification import normalize_string_tuple
...
from tracefold.news.ingest.url_identity import url_identity_kind
from tracefold.platform.postgres.payload_hash import stable_current_payload_hash
