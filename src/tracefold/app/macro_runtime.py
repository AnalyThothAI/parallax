...
from tracefold.integrations.macrodata import MacrodataBundleRunner, fred_api_key_state, macrodata_runtime_state
    ...
    *,
    ...
    try:
        ...
        service = MacroSyncService(
            settings=settings,
            repository_factory=lambda: _repositories(settings),
