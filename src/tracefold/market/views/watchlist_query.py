...
from tracefold.market.views.event_token_projection_query import EventTokenProjectionQuery
from tracefold.market.views.watchlist_types import (
...
class WatchlistQuery:
    ...
    def timeline(self, *, handle: str, cursor: str | None, limit: int) -> dict[str, Any]:
        normalized = normalize_watchlist_handle(handle)
        parsed_limit = require_positive_int(limit, error_code="watchlist_timeline_limit_required")
        ...
        return {
            "query": {"handle": normalized, "limit": parsed_limit},
            "items": visible,
            "has_more": has_more,
    ...
    def handle_overview(
        ...
        *,
        ...
        normalized = normalize_watchlist_handle(handle)
        parsed_source_limit = require_positive_int(source_limit, error_code="watchlist_source_limit_required")
        parsed_cluster_limit = require_positive_int(cluster_limit, error_code="watchlist_cluster_limit_required")
