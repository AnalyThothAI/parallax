...
def upgrade() -> None:
    op.execute("ALTER TABLE pulse_candidates DROP COLUMN narrative_type")
...
def downgrade() -> None:
    op.execute("ALTER TABLE pulse_candidates ADD COLUMN narrative_type TEXT NOT NULL DEFAULT 'direct_token'")
