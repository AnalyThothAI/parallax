...
EQUITY_EVENT_ALERT_PROJECTION_VERSION = "equity_event_alert_candidates_v1"
EQUITY_EVENT_TIMELINE_PROJECTION_VERSION = "equity_company_timeline_rows_v1"
EQUITY_EVENT_BRIEF_PROMPT_VERSION = "equity_event_brief_prompt_v1"
