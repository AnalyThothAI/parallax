...
CREATE TABLE IF NOT EXISTS account_token_alerts (
  ...
  chain TEXT,
  token_resolution_status TEXT NOT NULL,
  is_first_seen_global BOOLEAN NOT NULL,
  is_first_seen_by_author BOOLEAN NOT NULL,
  received_at_ms BIGINT NOT NULL,
  created_at_ms BIGINT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS event_token_attributions (
  ...
  attribution_rank BIGINT NOT NULL,
  candidate_count BIGINT NOT NULL,
  score_features_json JSONB NOT NULL DEFAULT '{}'::jsonb,
...
CREATE TABLE IF NOT EXISTS token_market_observations (
  ...
  address TEXT NOT NULL,
  symbol TEXT NOT NULL,
  target_received_at_ms BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS social_event_extractions (
  ...
  impact_hint DOUBLE PRECISION NOT NULL,
  semantic_novelty_hint DOUBLE PRECISION NOT NULL,
  confidence DOUBLE PRECISION NOT NULL,
  is_signal_event BOOLEAN NOT NULL,
  anchor_terms_json JSONB NOT NULL,
  token_candidates_json JSONB NOT NULL,
  semantic_risks_json JSONB NOT NULL,
...
CREATE TABLE IF NOT EXISTS attention_seeds (
  ...
  subject TEXT NOT NULL,
  anchor_terms_json JSONB NOT NULL,
  token_uptake_count BIGINT NOT NULL DEFAULT 0,
  top_linked_symbols_json JSONB NOT NULL DEFAULT '[]'::jsonb,
...
CREATE TABLE IF NOT EXISTS event_clusters (
  ...
  pricedness DOUBLE PRECISION NOT NULL,
  base_score DOUBLE PRECISION NOT NULL,
  event_score DOUBLE PRECISION NOT NULL,
  source_list_json JSONB NOT NULL DEFAULT '[]'::jsonb,
  raw_event_ids_json JSONB NOT NULL DEFAULT '[]'::jsonb,
...
CREATE TABLE IF NOT EXISTS harness_snapshots (
  ...
  event_clusters_json JSONB NOT NULL,
...
CREATE TABLE IF NOT EXISTS harness_outcomes (
  ...
  abnormal_return DOUBLE PRECISION NOT NULL,
  realized_vol DOUBLE PRECISION NOT NULL,
  normalized_outcome DOUBLE PRECISION NOT NULL,
...
CREATE TABLE IF NOT EXISTS harness_weights (
  ...
  horizon TEXT NOT NULL,
  n BIGINT NOT NULL,
  mean_credit DOUBLE PRECISION NOT NULL,
...
CREATE TABLE IF NOT EXISTS token_signal_snapshots (
  ...
  opportunity_score BIGINT NOT NULL,
  score_versions_json JSONB NOT NULL,
  component_payload_json JSONB NOT NULL,
  identity_json JSONB NOT NULL,
  market_json JSONB NOT NULL,
  flow_json JSONB NOT NULL,
  timeline_json JSONB NOT NULL,
  source_event_ids_json JSONB NOT NULL,
  market_snapshot_ids_json JSONB NOT NULL,
...
CREATE TABLE IF NOT EXISTS token_signal_outcomes (
  ...
  benchmark_snapshot_ids_json JSONB NOT NULL,
  entry_price DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS token_score_evaluations (
  ...
  bucket_max BIGINT NOT NULL,
  snapshot_count BIGINT NOT NULL,
  settled_count BIGINT NOT NULL,
  settlement_coverage DOUBLE PRECISION NOT NULL,
  avg_actual_return DOUBLE PRECISION NOT NULL,
  avg_abnormal_return DOUBLE PRECISION NOT NULL,
  avg_normalized_outcome DOUBLE PRECISION NOT NULL,
  directional_hit_rate DOUBLE PRECISION NOT NULL,
...
DROP TABLE IF EXISTS account_quality_snapshots CASCADE;
DROP TABLE IF EXISTS account_token_call_stats CASCADE;
...
DROP TABLE IF EXISTS social_event_extractions CASCADE;
DROP TABLE IF EXISTS model_runs CASCADE;
DROP TABLE IF EXISTS enrichment_jobs CASCADE;
DROP TABLE IF EXISTS token_market_observations CASCADE;
DROP TABLE IF EXISTS event_token_attributions CASCADE;
DROP TABLE IF EXISTS event_token_mentions CASCADE;
DROP TABLE IF EXISTS account_token_alerts CASCADE;
DROP TABLE IF EXISTS token_market_snapshots CASCADE;
DROP TABLE IF EXISTS token_aliases CASCADE;
