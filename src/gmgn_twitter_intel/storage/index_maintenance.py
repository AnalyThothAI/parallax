...
CORE_INDEXES: tuple[IndexSpec, ...] = (
    ...
    IndexSpec("twitter_events", "embedding_status", "scalar"),
    IndexSpec("twitter_events", "processing_priority", "scalar"),
    ...
    IndexSpec("tweet_entities", "token_resolution_status", "scalar"),
