...
_WORKER_MANIFESTS: tuple[WorkerManifest, ...] = (
    ...
    WorkerManifest(
        ...
        start_priority=50,
        input_contract=("token_capture_tier live targets", "live provider quotes"),
        ordering_keys=("target_type", "target_id"),
        writes_control_plane=("live price gateway cache",),
    ...
    WorkerManifest(
        ...
        start_priority=95,
        input_contract=("macro data providers",),
        ordering_keys=("series_id", "observed_at_ms"),
        writes_read_models=("macro_view_snapshots",),
    ...
    WorkerManifest(
        ...
        writes_facts=("notifications", "notification_deliveries"),
