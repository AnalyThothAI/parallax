...
AVAILABLE_FACTOR_KEYS = {
    ...
    "gates.max_decision",
    "market",
    "market.anchor_lag_ms",
    "market.anchor_observed_at_ms",
    "market.anchor_price_basis",
    "market.anchor_price_quote",
    "market.anchor_price_usd",
    "market.anchor_quote_symbol",
    "market.event_price_readiness",
    "market.market_status",
    "market.price_change_status",
    "market.provider",
    "market.social_signal_start_ms",
    "normalization",
