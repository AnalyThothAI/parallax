...
def test_project_uses_standard_uv_src_layout():
    ...
    assert (ROOT / "src" / "gmgn_twitter_intel" / "pipeline" / "narrative_seed_builder.py").is_file()
    assert (ROOT / "src" / "gmgn_twitter_intel" / "pipeline" / "narrative_token_linker.py").is_file()
    ...
    assert (ROOT / "src" / "gmgn_twitter_intel" / "retrieval" / "narrative_link_service.py").is_file()
    assert (ROOT / "src" / "gmgn_twitter_intel" / "retrieval" / "narrative_link_scoring.py").is_file()
