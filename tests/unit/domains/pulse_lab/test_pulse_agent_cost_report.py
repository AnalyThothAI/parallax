...
from gmgn_twitter_intel.domains.pulse_lab.services.pulse_agent_cost_report import (
...
def test_summarize_signal_pulse_agent_cost_rows_counts_cost_leak_signals() -> None:
    ...
    report = summarize_signal_pulse_agent_cost_rows(
        ...
        now_ms=NOW_MS,
        lookback_hours=24,
        dry_run_policy={"skip_deepseek_display_status_prefixes": ["hidden_"]},
    )
    ...
    assert report["predicted_savings"] == {
        "deepseek_tokens_before": 1_000,
        "deepseek_tokens_after": 200,
        "deepseek_token_reduction_ratio": 0.8,
    }
...
def test_build_signal_pulse_agent_cost_report_uses_read_only_selects() -> None:
    ...
    assert report["deepseek"]["total_tokens"] == 42
