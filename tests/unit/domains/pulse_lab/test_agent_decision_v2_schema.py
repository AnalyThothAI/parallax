...
Covers the BullBearView / TradePlaybook types and the v2-extended
FinalDecision hard constraints.
...
def test_final_decision_rejects_unknown_fields() -> None:
    kwargs = _hc_kwargs()
    kwargs["legacy_score"] = 99
