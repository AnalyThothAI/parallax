...
| `cex_oi_radar_board` (`CexOiRadarBoardWorker`) | `cex_market_intel` | `domains/cex_market_intel/runtime/cex_oi_radar_board_worker.py` | Binance-backed `price_feeds`, Binance USD-M ticker/premium/OI history | `cex_oi_radar_runs`, `cex_oi_radar_rows` | poll | none | `interval_seconds` |
