...
Either inline a Verification section here for small plans or link to `docs/superpowers/plans/<slug>/verification.md` for multi-PR work. The verification artefact must exist before the work is declared complete.
