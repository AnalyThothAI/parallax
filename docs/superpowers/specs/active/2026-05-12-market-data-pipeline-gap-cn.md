...
(见 `src/gmgn_twitter_intel/domains/token_intel/scoring/factor_snapshot.py:19-26`)
...
直接调用 OKX DEX API 验证 RKC 合约（脚本: `OkxDexClient` from `src/gmgn_twitter_intel/integrations/okx/dex_client.py:19`）：
...
**位置**：`src/gmgn_twitter_intel/integrations/okx/dex_client.py:39-53`
...
**位置**：`src/gmgn_twitter_intel/domains/asset_market/repositories/discovery_repository.py:39-44`
...
**位置**：`src/gmgn_twitter_intel/domains/asset_market/services/anchor_price_observation.py:164-203`（参考 Explore agent 报告）
...
**位置**：`src/gmgn_twitter_intel/domains/token_intel/services/token_radar_projection.py:585-665`
