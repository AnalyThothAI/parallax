...
The backend notification summary path currently selects every unread notification row and aggregates severity / author counts in Python. See `src/gmgn_twitter_intel/domains/notifications/repositories/notification_repository.py:318`, `src/gmgn_twitter_intel/domains/notifications/repositories/notification_repository.py:324`, and `src/gmgn_twitter_intel/domains/notifications/repositories/notification_repository.py:339`.
