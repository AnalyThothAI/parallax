...
- Modify `src/gmgn_twitter_intel/platform/db/alembic/versions/20260514_0043_watchlist_handle_intel.py`: add `lease_token` and expression index on `lower(author_handle)`.
