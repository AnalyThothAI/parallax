...
**Date**: 2026-06-11
**Owning spec**: `docs/sdd/features/completed/2026-06-11-executable-harness-followup/spec.md`
...
| AC23 - Subagent report mode is singular. | Pass | `uv --cache-dir /private/tmp/parallax-uv-cache run --no-sync pytest tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_multiple_top_level_modes -q` passed after report mode validation required a single top-level mode; the same test failed RED first because a matching mode beside another mode passed validation. |
...
|--------|-------|-----------|--------|
| agent loop and SDD artifact tests | 246 tests | >= targeted harness tests | Pass |
...
error: active-skipped-count-without-final-evidence: docs/sdd/features/completed/2026-06-11-executable-harness-followup/verification.md: active Skipped tests numeric run-above count requires successful final `make check-all` evidence in Verification commands; use non-final prose until that run exists
exit code: 1
...
$ uv --cache-dir /private/tmp/parallax-uv-cache run --no-sync pytest tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_requires_task_binding -q
.                                                                        [100%]
1 passed in 0.06s
exit code: 0
...
........................................................................ [ 90%]
.......................                                                  [100%]
239 passed in 13.25s
exit code: 0

$ UV_NO_SYNC=1 UV_CACHE_DIR=/private/tmp/parallax-uv-cache uv run ruff check scripts/validate_subagent_report.py scripts/subagent_report_contract.py tests/architecture/test_agent_playbook_contracts.py
All checks passed!
exit code: 0
...
$ UV_NO_SYNC=1 UV_CACHE_DIR=/private/tmp/parallax-uv-cache uv run pytest tests/architecture/test_agent_playbook_contracts.py::test_sdd_task_clis_reject_noncanonical_numeric_selectors -q
F                                                                        [100%]
AssertionError: build_agent_context_packet.py
# Context Packet - 2026-06-09-context-packet-fixture / Task 1
exit code: 1

$ UV_NO_SYNC=1 UV_CACHE_DIR=/private/tmp/parallax-uv-cache uv run pytest tests/architecture/test_agent_playbook_contracts.py::test_sdd_task_clis_reject_noncanonical_numeric_selectors tests/architecture/test_agent_playbook_contracts.py::test_sdd_task_clis_reject_title_substring_selectors tests/architecture/test_agent_playbook_contracts.py::test_sdd_task_clis_match_exact_task_numbers tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_accepts_task_bound_report -q
....                                                                     [100%]
4 passed in 0.32s
exit code: 0

$ uv --cache-dir /private/tmp/parallax-uv-cache run --no-sync pytest tests/architecture/test_agent_playbook_contracts.py::test_sdd_task_clis_reject_noncanonical_numeric_selectors -q
.                                                                        [100%]
1 passed in 0.10s
exit code: 0
...
$ UV_NO_SYNC=1 UV_CACHE_DIR=/private/tmp/parallax-uv-cache uv run pytest tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_mode_inside_fenced_block -q
F                                                                        [100%]
AssertionError: assert 0 == 1
...
$ uv --cache-dir /private/tmp/parallax-uv-cache run --no-sync pytest tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_mode_inside_fenced_block -q
.                                                                        [100%]
1 passed in 0.09s
exit code: 0
...
$ UV_NO_SYNC=1 UV_CACHE_DIR=/private/tmp/parallax-uv-cache uv run pytest tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_sections_inside_fenced_block -q
F                                                                        [100%]
AssertionError: assert 0 == 1
stdout='Subagent report validation passed.\n'
exit code: 1
...
$ uv --cache-dir /private/tmp/parallax-uv-cache run --no-sync pytest tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_sections_inside_fenced_block -q
.                                                                        [100%]
1 passed in 0.10s
exit code: 0
...
$ UV_NO_SYNC=1 UV_CACHE_DIR=/private/tmp/parallax-uv-cache uv run pytest tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_multiple_top_level_modes -q
F                                                                        [100%]
AssertionError: assert 0 == 1
stdout='Subagent report validation passed.\n'
exit code: 1

$ UV_NO_SYNC=1 UV_CACHE_DIR=/private/tmp/parallax-uv-cache uv run pytest tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_multiple_top_level_modes tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_mode_inside_fenced_block tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_accepts_task_bound_report tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_scope_and_reading_claims_inside_fenced_blocks -q
....                                                                     [100%]
4 passed in 0.47s
exit code: 0

$ uv --cache-dir /private/tmp/parallax-uv-cache run --no-sync pytest tests/architecture/test_agent_playbook_contracts.py::test_subagent_report_validator_rejects_multiple_top_level_modes -q
.                                                                        [100%]
1 passed in 0.12s
exit code: 0
