...
- `docs/sdd/features/completed/2026-06-11-executable-harness-followup`: own the follow-up active work.
...
Verification evidence lives in `docs/sdd/features/completed/2026-06-11-executable-harness-followup/verification.md`.
