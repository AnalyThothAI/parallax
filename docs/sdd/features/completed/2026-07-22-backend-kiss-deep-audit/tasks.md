...
- **File(s)**: `docs/sdd/features/completed/2026-07-22-backend-kiss-deep-audit/spec.md`, `docs/sdd/features/completed/2026-07-22-backend-kiss-deep-audit/plan.md`, `docs/sdd/features/completed/2026-07-22-backend-kiss-deep-audit/tasks.md`
- **Owner**: parent
- **Depends on**: Task 1-4
- **Touch set**: `docs/sdd/features/completed/2026-07-22-backend-kiss-deep-audit`
...
- **File(s)**: `src/parallax/domains/token_intel/queries/event_token_projection_query.py`; `src/parallax/platform/db/alembic/versions/20260722_0188_token_radar_factor_cache_hard_cut.py`; `tests/unit/test_event_token_projection.py`; `tests/unit/test_postgres_schema.py`; `tests/integration/test_postgres_schema_runtime.py`; `docs/sdd/features/completed/2026-07-22-backend-kiss-deep-audit`; `docs/reviews/backend-kiss-hard-cut-implementation-audit-zh-2026-07-22.md`; `docs/DESIGN_DISCIPLINE.md`; `docs/references/POSTGRES_PERFORMANCE.md`; `docs/generated/sdd-work-index.md`; `docs/generated/cli-help.md`; `docs/generated/subagent-handoffs/backend-kiss-deep-audit-task-10.md`; `docs/generated/subagent-reports/backend-kiss-deep-audit-task-10.md`
