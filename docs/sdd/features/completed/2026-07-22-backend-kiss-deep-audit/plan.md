...
- `docs/sdd/features/completed/2026-07-22-backend-kiss-deep-audit/{spec,plan,tasks,verification}.md`: keep decisions, exact touch sets, TDD order, and evidence current.
...
Verification evidence lives in `docs/sdd/features/completed/2026-07-22-backend-kiss-deep-audit/verification.md`. The feature is verified from its recorded direct evidence; omitted lanes remain explicit.
