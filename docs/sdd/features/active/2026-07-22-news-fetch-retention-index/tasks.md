...
- **Conflict set**: `src/parallax/platform/db/alembic/versions/20260721_0185_backend_kiss_hard_cut.py`; `src/parallax/platform/db/alembic/versions/20260722_0186_runtime_projection_hard_cut.py`
...
- **File(s)**: `docs/sdd/features/active/2026-07-22-news-fetch-retention-index/verification.md`
- **Owner**: parent
- **Depends on**: Task 1
- **Touch set**: `docs/sdd/features/active/2026-07-22-news-fetch-retention-index/verification.md`
