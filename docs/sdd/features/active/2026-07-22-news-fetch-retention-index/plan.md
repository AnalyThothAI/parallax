...
Evidence lives in `docs/sdd/features/active/2026-07-22-news-fetch-retention-index/verification.md`. The record remains Review unless the full repository completion gate is run with no skips.
