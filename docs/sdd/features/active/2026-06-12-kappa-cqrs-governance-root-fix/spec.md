...
- AC429. SUPERSEDED by AC448. Target-post responses SHALL preserve raw post evidence without Narrative semantic hydration; `hydrate_target_posts`, `semantics_for_posts`, and `token_mention_semantics` reads SHALL not exist.
