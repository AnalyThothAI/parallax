...
- `docs/sdd/features/active/2026-06-18-news-trading-agent-hard-cut/spec.md`
- `docs/sdd/features/active/2026-06-18-news-trading-agent-hard-cut/plan.md`
- `docs/sdd/features/active/2026-06-18-news-trading-agent-hard-cut/tasks.md`
- `docs/sdd/features/active/2026-06-18-news-trading-agent-hard-cut/verification.md`
...
Scoped backend verification evidence lives in `docs/sdd/features/active/2026-06-18-news-trading-agent-hard-cut/verification.md`. This active record is not `Verified` until the final repository and runtime gates are recorded there.
