...
| `domains/asset_market/` | Asset registry, chain/address identity, asset identity evidence/current identity selection, price observations, discovery, asset-market sync, message-market observation. |
