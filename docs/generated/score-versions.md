...
| `token_factor_snapshot_v3_social_attention` | `src/gmgn_twitter_intel/domains/token_intel/_constants.py` | 12 | `TOKEN_FACTOR_SNAPSHOT_VERSION = "token_factor_snapshot_v3_social_attention"` |
